...
export class UpsertScheduleExceptionInput {
  ...
  @Field(() => Boolean, {
    defaultValue: false,
    description: 'true: la zona no abre ese día',
  })
  @IsBoolean()
  ...
  @Field(() => String, {
    nullable: true,
    description: 'Requerido si isClosed=false. Formato HH:mm',
  })
  @IsOptional()
  ...
  @Field(() => String, {
    nullable: true,
    description: 'Motivo; el residente lo ve cuando el día queda cerrado',
  })
  @IsOptional()
  @IsString()
  @MaxLength(200)
