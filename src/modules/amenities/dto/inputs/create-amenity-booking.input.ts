...
export class CreateAmenityBookingInput {
  ...
  @Field(() => String, {
    nullable: true,
    description: 'Motivo del evento (ej. cumpleaños)',
  })
  @IsOptional()
  @IsString()
  @MaxLength(200)
  ...
  @Field(() => Boolean, {
    defaultValue: true,
    description: 'Usar el cupo anual del consejo si aplica',
  })
  @IsOptional()
  @IsBoolean()
  ...
  @Field(() => String, {
    nullable: true,
    description: 'Unidad a nombre de la cual se reserva (solo staff)',
  })
  @IsOptional()
  @IsUUID()
  unitId?: string;
