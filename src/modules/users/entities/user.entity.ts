...
@Index(['identity'], {
  unique: true,
  where: '"identity" IS NOT NULL AND "deleted_at" IS NULL',
})
@Index(['status', 'createdAt'])
@Index(['rating'])
@Index(['lastName', 'name'])
@Check(
  'CHK_user_age_validation',
...
export class User {
  ...
  @Field(() => String, {
    description: 'Profile picture of port URL',
    nullable: true,
  })
  coverPicture?: string;
  ...
  @Field(() => Date, {
    description: 'Bloqueo temporal por intentos fallidos de clave de acceso',
    nullable: true,
  })
  @Column({
    name: 'access_code_locked_until',
    type: 'timestamptz',
    nullable: true,
  })
  ...
  @Field(() => String, {
    description: 'ID del complejo residencial asociado',
    nullable: true,
  })
  complexId?: string;

  @Column({
    name: 'company_card_url',
    type: 'varchar',
    length: 500,
    nullable: true,
  })
  ...
  @Field(() => [Permission], {
    nullable: true,
    description: 'Permissions created by this user',
  })
  ...
  @Field(() => [Permission], {
    nullable: true,
    description: 'Permissions last updated by this user',
  })
  updatedPermissions?: Permission[];

  @OneToMany(
    () => VisitorParkingRate,
    (visitorParking) => visitorParking.createdByUser,
  )
  @Field(() => [VisitorParkingRate], {
    nullable: true,
    description: 'Visitor last created by this user',
  })
  createVisitorParking?: VisitorParkingRate[];

  @OneToMany(
    () => VisitorParkingRate,
    (visitorParking) => visitorParking.updatedByUser,
  )
  @Field(() => [VisitorParkingRate], {
    nullable: true,
    description: 'Visitor last updated by this user',
  })
  ...
  @Field(() => [UserRole], {
    description: 'Detalles completos de la relación usuario-rol',
    nullable: true,
  })
  ...
  @Field(() => Number, {
    description: 'Edad calculada del usuario basada en su fecha de nacimiento',
    nullable: true,
  })
  get age(): number | null {
