...
@ObjectType({
  description: 'Registro de auditoría de una acción realizada en el sistema',
})
@Entity('audit_logs')
...
export class AuditLog {
  ...
  @Field(() => String, {
    description: 'Número de referencia único (AUD-YYYYMMDD-XXXX)',
  })
  @Column({
  ...
  @Field(() => GraphQLJSON, {
    description: 'Estado de la entidad ANTES de la acción (null en CREATE)',
    nullable: true,
  })
  ...
  @Field(() => GraphQLJSON, {
    description: 'Estado de la entidad DESPUÉS de la acción (null en DELETE)',
    nullable: true,
  })
  ...
  @Field(() => String, {
    description: 'ID del usuario o complejo que realizó la acción',
  })
  @Column({ name: 'performed_by_id', type: 'varchar', length: 100 })
  performedById: string;

  @Field(() => String, {
    description: 'Nombre para mostrar del actor (email, nombre, etc.)',
    nullable: true,
  })
  @Column({
  ...
  @Field(() => Boolean, {
    description: 'Indica si esta acción fue revertida',
    defaultValue: false,
  })
  ...
  @Field(() => Date, {
    description: 'Fecha en que fue revertida',
    nullable: true,
  })
  ...
  @Field(() => String, {
    description: 'ID del usuario que revirtió la acción',
    nullable: true,
  })
  @Column({
    name: 'reverted_by_id',
