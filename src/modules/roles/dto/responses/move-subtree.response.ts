...
export class MoveSubtreeResponse {
  ...
  @Field(() => Int, {
    description: 'Number of descendant roles that were also moved',
  })
  descendantsCount: number;

  @Field(() => SimpleRoleResponse, {
    description: 'New parent role information',
    nullable: true,
  })
  newParent?: SimpleRoleResponse;

  @Field(() => Int, {
    description: 'Total number of roles affected by this move',
  })
