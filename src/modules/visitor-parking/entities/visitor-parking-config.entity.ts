...
@ObjectType({
  description: 'Configuración del parqueadero para vehículos visitantes',
})
...
export class VisitorParkingConfig {
  ...
  @Field(() => Int, {
    nullable: true,
    description: 'Capacidad máxima de vehículos visitantes simultáneos',
  })
  ...
  @Field(() => Int, {
    nullable: true,
    description: 'Minutos de gracia antes de empezar a cobrar',
  })
  ...
  @Field(() => String, {
    nullable: true,
    description: 'Mensaje que aparece en el recibo de parqueadero',
  })
  @Column({
  ...
  @Field(() => Boolean, {
    description: 'Mostrar logo del complejo en el recibo',
  })
  @Column({
  ...
  @Field(() => String, {
    nullable: true,
    description: 'ID de la tarifa activa por defecto',
  })
  @Column({ name: 'active_rate_id', type: 'uuid', nullable: true })
  activeRateId?: string;

  @Field(() => String, {
    description: 'Moneda principal del parqueadero (ej. COP, USD)',
  })
  ...
  @Field(() => [VisitorParkingRate], {
    description: 'Tarifas configuradas para el parqueadero',
  })
  @OneToMany(() => VisitorParkingRate, (rate) => rate.config, {
    cascade: true,
    eager: false,
  })
  ...
  @Field(() => ResidentialComplex, {
    nullable: true,
    description: 'Complejo residencial asociado a esta configuración',
  })
