 ...
 */
@ObjectType({
  description: 'Evento de visita: entrada, salida, estado y QR de acceso',
})
@Entity({ name: 'visits' })
...
export class Visit {
  ...
  @Column({
    type: 'enum',
    enum: VisitStatus,
    default: VisitStatus.PENDING_APPROVAL,
  })
  status: VisitStatus;
  ...
  @Field(() => Date, {
    description: 'Fecha/hora esperada de llegada (visitas programadas)',
    nullable: true,
  })
  ...
  @Field(() => Date, {
    description: 'Fecha/hora límite de llegada',
    nullable: true,
  })
  @Column({
    name: 'expected_arrival_until',
    type: 'timestamptz',
    nullable: true,
  })
  ...
  @Field(() => String, {
    description: 'Token único del QR de acceso',
    nullable: true,
  })
  ...
  @Field(() => Date, {
    description: 'Momento en que el residente aprobó la visita',
    nullable: true,
  })
  @Column({
    name: 'approved_by_resident_at',
    type: 'timestamptz',
    nullable: true,
  })
  ...
  @Field(() => Date, {
    description: 'Momento en que el residente rechazó la visita',
    nullable: true,
  })
  @Column({
    name: 'denied_by_resident_at',
    type: 'timestamptz',
    nullable: true,
  })
  ...
  @Field(() => String, {
    description: 'Razón del rechazo por parte del residente',
    nullable: true,
  })
  @Column({
    name: 'denial_reason',
  ...
  @Field(() => String, {
    description: 'Notas del guardia de seguridad',
    nullable: true,
  })
  ...
  @Field(() => String, {
    description: 'ID del guardia que registró la visita',
    nullable: true,
  })
  ...
  @Field(() => String, {
    description: 'ID del guardia que registró la salida',
    nullable: true,
  })
  ...
  @Field(() => User, {
    description: 'Guardia que registró la visita',
    nullable: true,
  })
  ...
  @Field(() => User, {
    description: 'Guardia que registró la salida',
    nullable: true,
  })
  @ManyToOne(() => User, { onDelete: 'SET NULL', nullable: true })
