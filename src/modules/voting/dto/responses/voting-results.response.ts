...
export class VotingOptionResult {
  ...
  @Field(() => Int, {
    description: 'Cuántas unidades o consejeros la eligieron',
  })
  votes: number;

  @Field(() => Float, {
    description: 'Suma de pesos: coeficientes, unidades o consejeros',
  })
  weight: number;
   ...
   */
  @Field(() => Float, {
    description: 'Fracción del total habilitado para votar (0 a 1)',
  })
...
export class VotingBallotView {
  @Field(() => String, {
    description: 'Unidad ("Torre 2 · 301") o nombre del consejero',
  })
  voterLabel: string;

  @Field(() => String, {
    nullable: true,
    description: 'Persona que registró el voto',
  })
...
export class VotingResults {
  ...
  @Field(() => Float, {
    description: 'Peso que votó sobre el habilitado (0 a 1)',
  })
