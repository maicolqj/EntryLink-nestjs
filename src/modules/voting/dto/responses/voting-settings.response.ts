...
@ObjectType('VotingSettings', { description: 'Módulo e interruptores de votaciones del complejo' })
export class VotingSettingsResponse {

  @Field(() => Boolean, { description: 'El SUPER_ADMIN le habilitó el módulo al complejo' })
