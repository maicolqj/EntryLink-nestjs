...
export class FilterResidentsInput {
  @Field(() => String, {
    nullable: true,
    description: 'Buscar por nombre, apellido o email del usuario',
  })
  @IsOptional()
  @IsString()
  search?: string;
  ...
  @Field(() => String, {
    nullable: true,
    description: 'Filtrar por edificio/torre (UUID)',
  })
  @IsOptional()
  @IsUUID()
  buildingId?: string;
  ...
  @Field(() => String, {
    nullable: true,
    description: 'Filtrar por unidad específica (UUID)',
  })
  @IsOptional()
  @IsUUID()
  unitId?: string;
  ...
  @Field(() => UnitType, {
    nullable: true,
    description: 'Tipo de unidad: HOUSE, APARTMENT, OFFICE...',
  })
  @IsOptional()
  @IsEnum(UnitType)
  unitType?: UnitType;
  ...
  @Field(() => String, {
    nullable: true,
    description: 'Número/identificador de la unidad (ej: "39", "601")',
  })
  @IsOptional()
  @IsString()
  unitNumber?: string;
