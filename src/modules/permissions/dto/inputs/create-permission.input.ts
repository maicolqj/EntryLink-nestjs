...
export class CreatePermissionInput {
  ...
  @Matches(/^[A-ZÁÉÍÓÚ_]+$/, {
    message:
      'El nombre debe contener solo mayúsculas y guiones bajos (ej: CREAR_PERMISO)',
  })
  ...
  @IsString()
  @MaxLength(100, {
    message: 'El nombre para el front no puede superar los 100 caracteres',
  })
  @Matches(/^[A-ZÁÉÍÓÚ_]+$/, {
    message:
      'El label debe contener solo mayúsculas y guiones bajos (ej: CREAR_PERMISO)',
  })
  label: string;
  ...
  @IsEnum(PermissionLevel, {
    message: 'Los valores permitidos son LOW, MEDIUM, HIGH, CRITICAL',
  })
  ...
  @IsOptional()
  @Field(() => [PermissionDependencyInput], {
    description:
  ...
  @Field(() => Boolean, {
    nullable: true,
    defaultValue: false,
    description: 'Si es true, no podrá borrarse por API',
  })
  @IsBoolean()
  @IsOptional()
  isSystem?: boolean;
