...
export class RemovePermissionResponse {
  ...
  @Field(() => Boolean, {
    description: 'Status of the permission (false when deleted)',
  })
  status: boolean;
  ...
  @Field(() => Boolean, {
    description: 'Indicates if it is a system permission',
  })
  isSystem: boolean;
  ...
  @Field(() => [PermissionDependencyRemoveResponse], {
    description: 'Permission dependencies',
  })
