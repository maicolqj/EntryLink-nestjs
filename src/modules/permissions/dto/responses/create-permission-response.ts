...
export class CreatePermissionResponse {
  ...
  @Field(() => [PermissionDependencyResponse], {
    description:
  ...
  @Field(() => Boolean, {
    description: 'indicates if permission is active',
    nullable: true,
  })
  status?: boolean;
  ...
  @Field(() => Boolean, {
    description: 'Select critical permissions that cannot be removed',
    nullable: true,
  })
  isSystem: boolean;
  ...
  @Field(() => String, {
    description: 'category to which a permit belongs',
    nullable: true,
  })
  category?: string;
