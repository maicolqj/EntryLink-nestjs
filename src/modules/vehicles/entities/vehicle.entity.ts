...
@ObjectType({
  description: 'Vehículo de un residente registrado en el complejo',
})
...
export class Vehicle {
  ...
  @Field(() => String, {
    description: 'Placa del vehículo (normalizada: sin espacios, mayúsculas)',
  })
  ...
  @Field(() => String, {
    description: 'Marca del vehículo. Ej: Toyota, Renault',
    nullable: true,
  })
  ...
  @Field(() => String, {
    description: 'Modelo. Ej: Corolla, Logan',
    nullable: true,
  })
  @Column({ type: 'varchar', length: 50, nullable: true })
  model?: string;
  ...
  @Field(() => String, {
    description: 'Número o código del parqueadero asignado',
    nullable: true,
  })
  ...
  @Field(() => VehicleStatus, {
    description: 'Estado del vehículo en el complejo',
  })
  @Column({
    type: 'enum',
    enum: VehicleStatus,
  ...
  @Field(() => String, {
    description: 'Razón de rechazo o suspensión',
    nullable: true,
  })
  ...
  @Field(() => String, {
    description: 'ID del residente propietario del vehículo',
    nullable: true,
  })
  ...
  @Field(() => String, {
    description: 'ID de la unidad (desnormalizado de residente)',
  })
  ...
  @Field(() => String, {
    description: 'ID del usuario que aprobó o rechazó',
    nullable: true,
  })
  ...
  @Field(() => Resident, {
    description: 'Residente propietario',
    nullable: true,
  })
  ...
  @Field(() => Unit, {
    description: 'Unidad a la que pertenece',
    nullable: true,
  })
  ...
  @Field(() => User, {
    description: 'Usuario que aprobó/rechazó el vehículo',
    nullable: true,
  })
