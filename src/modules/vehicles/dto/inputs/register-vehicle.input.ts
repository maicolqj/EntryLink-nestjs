...
export class RegisterVehicleInput {
  @Field(() => String, {
    description: 'Placa del vehículo. Ej: ABC123, ABC12D',
  })
  @IsString()
  @Matches(/^[A-Za-z0-9]{3,10}$/, {
    message:
      'La placa debe tener entre 3 y 10 caracteres alfanuméricos sin espacios ni guiones',
  })
  plate: string;
  ...
  @Field(() => String, {
    description: 'Marca. Ej: Toyota, Renault',
    nullable: true,
  })
  @IsOptional()
  @IsString()
  ...
  @Field(() => String, {
    description: 'Número de parqueadero asignado (opcional)',
    nullable: true,
  })
  @IsOptional()
  @IsString()
  ...
  @Field(() => String, {
    description: 'ID de la unidad a la que pertenece el vehículo',
  })
  @IsUUID()
  unitId: string;
