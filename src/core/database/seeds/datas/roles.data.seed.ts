...
export const ROLES_TO_SEED: RoleSeedData[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      // El guarda reporta lo que ve en la ronda y sigue el estado; no asigna
      // proveedores ni cierra tickets.
  ...
  },
  {
    ...
    permissions: [
      ...
      ValidPermissions.VIEW_MAINTENANCE_TICKETS,
      ValidPermissions.REPORT_MAINTENANCE_TICKET,
      ValidPermissions.MANAGE_MAINTENANCE_TICKETS,
      ValidPermissions.CLOSE_MAINTENANCE_TICKET,
    ],
