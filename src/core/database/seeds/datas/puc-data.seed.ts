import {
  AccountNature,
  AccountClass,
} from '../../../../modules/finance/enums/account-nature.enum';
...
export const PUC_PH_SEED: PucSeedRow[] = [
  ...
  {
    code: '1311',
    name: 'Cuotas de administración por cobrar',
    accountClass: AccountClass.ASSET,
    nature: AccountNature.DEBIT,
    isPostable: true,
    level: 3,
  ...
  {
    code: '1345',
    name: 'Multas e intereses por cobrar',
    accountClass: AccountClass.ASSET,
    nature: AccountNature.DEBIT,
    isPostable: true,
    level: 3,
  ...
  {
    code: '2335',
    name: 'Costos y gastos por pagar (proveedores)',
    accountClass: AccountClass.LIABILITY,
    nature: AccountNature.CREDIT,
    isPostable: true,
    level: 3,
  ...
  {
    code: '2805',
    name: 'Ingresos recibidos por anticipado (anticipos)',
    accountClass: AccountClass.LIABILITY,
    nature: AccountNature.CREDIT,
    isPostable: true,
    level: 3,
  ...
  {
    code: '3205',
    name: 'Fondo de imprevistos (Ley 675 art. 35)',
    accountClass: AccountClass.EQUITY,
    nature: AccountNature.CREDIT,
    isPostable: true,
    level: 3,
