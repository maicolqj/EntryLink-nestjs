...
export const BK = {
  ...
  unit: {
    list: (
      ...
      prefix: 'unit',
      key: `${complexId}:${buildingId}:${status}:${search}:${page}:${limit}`,
    }),
  ...
  resident: {
    ...
    list: (
      ...
      prefix: 'res',
      key: `${complexId}:list:${page}:${limit}:${filterKey}`,
    }),
  ...
  finance: {
    ...
    feeConfigs: (complexId: string) => ({
      prefix: 'fin',
      key: `${complexId}:fees`,
    }),
    categories: (complexId: string) => ({
      prefix: 'fin',
      key: `${complexId}:cats`,
    }),
  ...
  amenity: {
    list: (complexId: string, filterKey: string) => ({
      prefix: 'amn',
      key: `${complexId}:list:${filterKey}`,
    }),
    one: (complexId: string, amenityId: string) => ({
      prefix: 'amn',
      key: `${complexId}:one:${amenityId}`,
    }),
    availability: (
      complexId: string,
      amenityId: string,
      ...
      prefix: 'amn',
      key: `${complexId}:avail:${amenityId}:${from}:${to}`,
    }),
